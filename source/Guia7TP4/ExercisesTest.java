...
//        printMatrix(independtTerms1);
        ...
        double[][] matrix2 = {{2,0,0},{6,3,0},{15,10,5}};
        double[] independtTerms2 = {4,3,25};
        printMatrix(matrix2);
        printMatrix(independtTerms2);

        System.out.println("Exercise 2 solution:");
        printMatrix(exercises.exercise2(matrix2,independtTerms2));
//
//        System.out.println("Exercises 5 without pivote solution: ");
//        printMatrix(exercises.exercise5WithoutPivoteo(matrix1,indepen dtTerms1));
